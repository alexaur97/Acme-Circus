...
<display:table pagesize="5" name="tours" id="tour"
	...
	<display:column titleKey="tour.categoryTour"
		property="categoryTour.name" />
	...
	<jstl:if test="${error eq true}">
		...
		<spring:message code="tour.categoryprice.error" />
...
<security:authorize access="hasRole('ORGANIZER')">
	...
	<acme:cancel url="/tour/organizer/create.do" code="tour.create" />
